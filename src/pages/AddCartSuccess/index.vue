    ...
    <div class="cart-complete">
      ...
      <div class="goods">
        ...
        <div class="right-gocart">
          ...
          <router-link :to="`/detail/${this.skuInfo.id}`" class="sui-btn btn-xlarge">查看商品详情</router-link>
          <router-link to="/shopcart" href="javascript:" >去购物车结算 > </router-link>
        </div>
      </div>
    </div>
  </div>
...
<script>
  export default {
    name: 'AddCartSuccess',
    computed:{
      //从sesssessionStorage获取加入购物车的商品信息
      skuInfo(){
